...
<html>
	...
	$reg = mysqli_fetch_assoc($registros);  // Obtener una fila de resultados como un array enumerado
	//$reg = mysqli_fetch_array($registros);  // Obtiene una fila de resultados como un array asociativo, numérico, o ambos
	//$reg = mysqli_fetch_row($registros);  // Obtener una fila de resultados como un array enumerado
		...
		<div class="row"> <!-- 12 filas de división -->
			<div class="col-sm-6 offset-sm-3 text-center">
				...
				<div class="form-group text-left">
					...
					<!-- En el input anterior en lugar de readonly se puede poner del tipo hidden (eliminar el label también) -->
				</div>
